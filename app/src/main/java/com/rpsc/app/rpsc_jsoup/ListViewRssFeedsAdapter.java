...
public class ListViewRssFeedsAdapter extends BaseAdapter implements Filterable {
    ...
    RssActivity aka_instance = new RssActivity();

    public ListViewRssFeedsAdapter(Context context,
...
//        ImageView flag;
        ...
        description = (TextView) itemView.findViewById(R.id.papernotetitle);
        link = (TextView) itemView.findViewById(R.id.papernotetitle);
